...
/go/src/github.com/tidbyt/pixlet/pixlet render usemotion.star apiKey=$9 && /go/src/github.com/tidbyt/pixlet/pixlet push --api-token $1 --installation-id Fi $2 -b /fi.webp